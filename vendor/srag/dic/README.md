...
```php
\srag\DIC\LearningObjectiveSuggestions\x\DICStatic::dic()->database()->createAutoIncrement(\srag\Plugins\x\x\x::TABLE_NAME, "id");
```
...
```php
...
use srag\DIC\LearningObjectiveSuggestions\x\DevTools\DevToolsCtrl;
...
    /**
     * @inheritDoc
     */
...
/**
 * ...
 * @ilCtrl_isCalledBy srag\DIC\LearningObjectiveSuggestions\x\DevTools\DevToolsCtrl: ilXConfigGUI
 */
class ...
...
    /**
